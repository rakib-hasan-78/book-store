...
const EmptyState = ({children}) => {
    ...
    return (
        <div
            className="w-full lg:max-w-4xl mx-auto  py-40  flex flex-col items-center justify-center text-center bg-cover bg-center bg-no-repeat relative z-10 before:content-[''] before:absolute before:top-0 before:left-0 before:w-full before:h-full before:bg-stone-200/5 before:bg-opacity-40 before:-z-10"
